  ...
  ngOnInit(): void {
   ...
   this.view=   new View({
    ...
    this.route.params.subscribe((params:Params)=>{ 
     ...
     if(this.user.provinces.length>0){
      this.lrsServiceService.getProvincesJson(this.user.provinces).subscribe((res)=>{
     ...
     this.mapPrevLine.getView().setCenter(this.getCenterOfExtent(this.mediumLowAnnsrc.getExtent()))
     if(res.length>1) this.mapPrevLine.getView().setZoom(8)
    })
     }
